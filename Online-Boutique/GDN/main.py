...
# 如需更改数据集地址，更改-dataset参数即可，如-dataset mydata；同时更改保存路径，更改-save_path_pattern参数即可，如-save_path_pattern mydata；更改-save_path_pattern参数后，程序会在./pretrained和./results下创建mydata文件夹，并将模型和结果保存到该文件夹下。
# 更改-comment msl为对应数据集名称如-comment mydata
# 更改训练参数如-batch, -epoch等
